...
const ModalEndGame = ({title, content, buttons}: {title: string, content: JSX.Element, buttons: JSX.Element}) => {
  return (
    <div className='z-40 fixed bg-[rgba(0,0,0,0.85)] top-0 left-0 w-full h-full text-center align-middle flex flex-col justify-center items-center'>
