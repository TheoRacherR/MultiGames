...
export const modeFlagList = [modeQuiz.ALL, modeQuiz.FIVE, modeQuiz.TEN, modeQuiz.TWENTY];
export const modeCountryList = [modeQuiz.ALL, modeQuiz.AFRICA, modeQuiz.ASIA, modeQuiz.EUROPE, modeQuiz.NORTH_AMERICA, modeQuiz.SOUTH_AMERICA, modeQuiz.OCEANIA];
