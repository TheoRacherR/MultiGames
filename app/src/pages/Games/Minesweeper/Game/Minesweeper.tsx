        ...
        <div className="bg-white text-[#5533EA] rounded-2xl shadow-xl p-6">
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex items-center gap-4">
              <div id="timer" className="text-white bg-[#6C4EF6] px-4 py-2 rounded-lg font-bold">00:00</div>
              <div className="text-sm text-[#6B5BEA]">Drapeaux restants: <span id="flagsRemaining" className="font-bold">0</span></div>
            </div>
          </div>
          ...
          <section className="flex flex-wrap items-center gap-4 mb-6 controls">
            <label className="flex items-center gap-2 text-sm">
              ...
              <select id="difficulty" className="px-3 py-2 rounded-lg bg-[#F9F9FF] text-[#5533EA] border border-[#D9D4F8]">
                <option value="easy">Facile (8x8, 10 mines)</option>
                <option value="medium" selected>Moyen (12x12, 24 mines)</option>
                <option value="hard">Difficile (16x16, 40 mines)</option>
              </select>
            </label>

            <button id="newGameBtn" className="btn px-4 py-2 rounded-lg bg-[#6C4EF6] text-white font-semibold">Nouvelle partie</button>
            <button id="autoPlaceBtn" className="btn px-3 py-2 rounded-lg bg-white text-[#5533EA] border border-[#D9D4F8] font-semibold">Placer aléatoire</button>
            <div id="status" className="text-sm text-[#6B5BEA] ml-4">Clique sur une case pour commencer.</div>
          </section>

          <section className="grid grid-cols-2 gap-6">
            <div className="grid-wrap">
              <div id="gridContainer" className="inline-block" role="grid" aria-label="Grille du démineur"></div>
            </div>
            ...
            <aside className="bg-[#FBF9FF] p-4 rounded-lg border border-[#EDE9FF] text-[#5533EA]">
              ...
              <div className="mb-4">
                ...
                <div className="text-sm mt-2">Temps écoulé : <span id="elapsed" className="font-medium">00:00</span></div>
                <div className="text-sm">Mines : <span id="mineCount" className="font-medium">0</span></div>
                <div className="text-sm">Cases restantes : <span id="cellsLeft" className="font-medium">0</span></div>
              </div>

              <div>
                <h4 className="font-semibold mb-2">Légende</h4>
                <div className="flex items-center gap-3 mb-2">
                  <div className="w-8 h-8 cell unrevealed inline-grid place-items-center rounded-md"> </div><div className="text-sm">Non révélé</div>
                </div>
                <div className="flex items-center gap-3 mb-2">
                  <div className="w-8 h-8 cell revealed inline-grid place-items-center rounded-md bg-white border">1</div><div className="text-sm">Chiffre = mines adjacentes</div>
                </div>
                <div className="flex items-center gap-3 mb-2">
                  <div className="w-8 h-8 rounded-md inline-grid place-items-center bg-[#FFF5F7] text-[#E53935]">⚑</div><div className="text-sm">Drapeau</div>
                </div>
              </div>
            </aside>
          </section>
